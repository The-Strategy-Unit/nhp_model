...
app_server <- function(input, output, session) {
  ...
  mod_principal_high_level_server("principal_high_level", selected_model_run, data_cache)
  mod_principal_detailed_server("principal_detailed", selected_model_run, data_cache)
  mod_principal_change_factor_effects_server("principal_change_factor_effects", selected_model_run, data_cache)

  mod_model_core_activity_server("model_core_activity", selected_model_run, data_cache)
  # TODO: need to change this significantly...
  # mod_model_results_distribution_server("model_results_distribution", selected_model_run, data_cache)
}
