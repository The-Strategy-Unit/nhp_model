...
def test_init_sets_values():
    ...
    # act
    d = NHPDataLocal("data", 2019, "synthetic")
...
def test_create_returns_lambda():
    ...
    # act
    d = NHPDataLocal.create("data")(2019, "synthetic")
...
def test_get_ip(mocker):
    # arrange
    m = mocker.patch(
        "model.nhp_data_local.NHPDataLocal._get_parquet", return_value="data"
    )
    d = NHPDataLocal("data", 2019, "synthetic")
...
def test_get_birth_factors(mocker):
    # arrange
    m = mocker.patch("model.nhp_data_local.NHPDataLocal._get_csv", return_value="data")
    d = NHPDataLocal("data", 2019, "synthetic")
